...
def turtle4():
    """
    Constructs a default SimpleTurtle.
    Makes that SimpleTurtle go right 300 units
    and then draw a violet octagon.
    """
    tony = rg.SimpleTurtle()
    tony.pen = rg.Pen('violet', 10)

    tony.right(300)

    tony.draw_regular_polygon(8,20)
...
def turtle5():
    ...
    """
    joe = rg.SimpleTurtle()
    joe.pen = rg.Pen("brown",30)
    sam = rg.SimpleTurtle()
    sam.pen = rg.Pen("red",50)
